...
// Define VSPI correctly for ESP32
#ifndef VSPI
...
// Placeholder for bitmap data for sun and moon icons
const uint16_t sun_icon[32 * 32] = { 0xFFFF }; // Replace with actual bitmap data
const uint16_t moon_icon[32 * 32] = { 0x0000 }; // Replace with actual bitmap data
...
void loop() {
  ...
  // Day/Night icon
  if (hours >= 6 && hours < 18) {
    M5.Lcd.drawBitmap(100, 100, 32, 32, sun_icon);
  } else {
    M5.Lcd.drawBitmap(100, 100, 32, 32, moon_icon);
  }
